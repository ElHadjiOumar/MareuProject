...
export default class CreateTask extends Component {
  ...
  _handleCreateEventData = async value => {
    const {
      state: {
        currentDay,taskText,notesText,isAlarmSet,alarmTime,createEventAsyncRes,
      },
      props: { navigation },
    } = this;
    ...
    const creatTodo = {
      ...
      todoList: [
        {
          key: uuid(),title: taskText,notes: notesText,
          alarm: {
            time: alarmTime,isOn: isAlarmSet,createEventAsyncRes,
          },
      ...
      markedDot: {
        ...
        dots: [
          {
            key: uuid(),color: '#2E66E7',selectedDotColor: '#2E66E7',
          },
        ],
      },
    };
              ...
              >
                ...
                >
                  <View style={styles.backButton}>
                    ...
                    <Text style={styles.newTask}>Nouvelle reunion</Text>
                  </View>
                    ...
                    <CalendarList
                      ...
                      onDayPress={day => {
                        this.setState({
                          selectedDay: {
                            [day.dateString]: {
                              selected: true,selectedColor: '#2E66E7',
                            },
                          },
                          currentDay: day.dateString,alarmTime: day.dateString,
                        });
                      }}
                      ...
                      markingType="simple"
                      theme={{
                        selectedDayBackgroundColor: '#2E66E7',selectedDayTextColor: '#ffffff',todayTextColor: '#2E66E7',backgroundColor: '#eaeef7',
                        calendarBackground: '#eaeef7',textDisabledColor: '#d9dbe0',
                      }}
                  ...
                  <View style={styles.taskContainer}>
                    ...
                    <Text
                      style={{
                        fontSize: 14,color: '#BDC6D8',marginVertical: 10,
                      }}
                    >
                      Reunions :
                    </Text>
                    ...
                    <View>
                      <Text style={styles.notes}>Participants</Text>
                      <TextInput
                        style={{
                          height: 25,fontSize: 19,marginTop: 3,
                        }}
                        onChangeText={text =>
                    ...
                    <View>
                      <Text
                        style={{
                          color: '#9CAAC4',fontSize: 16,fontWeight: '600',
                        }}
                      >
                        Heures
                      </Text>
